...
@Test
@CucumberOptions(
        features = "src/test/resources/features/SLASFeatures/HigherInstitutions.feature",
...
public class HigherInstitutionsTestRunner extends AbstractTestNGCucumberTests {
    @Override
